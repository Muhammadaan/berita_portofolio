...
class Authuser extends CI_Controller {
	...
	public function index()
	{
		...
		$this->template->load("templateauth","authuser/Successsendemail",$data);
	...
	public function register()
	{
        ...
        if ($this->form_validation->run() == FALSE || !isset($response['success']) || $response['success'] <> true ) {
        		...
        		$this->template->load('templateauth','authuser/Register',$data);
		...
		$this->form_validation->set_rules('password', 'password', 'trim|required');
			...
			if ($this->form_validation->run() == TRUE ) {
				...
				if (is_array($user)) {
					...
					$data['success_message'] = $this->session->flashdata('success_message');
					$this->template->load('templateauth','authuser/Login',$data);
				}
	...
	public function forgot()
	{
		...
		if ($this->form_validation->run() == TRUE ) {
			...
			$data['error_message'] = ( validation_errors()) ? validation_errors(): $this->session->flashdata('error_message');
			$this->template->load('templateauth','authuser/Forgot',$data);
