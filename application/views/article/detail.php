                        ...
                        <div class="large-widget m30">
                            <div class="post clearfix">
                                ...
                                <div class="title-area">
                                    ...
                                    <div class="post-sharing">
                                        <ul class="list-inline">
                                            ...
                                            <li><a class="fb-button btn btn-primary" href="http://www.facebook.com/share.php?u=http://127.0.0.1/berita/article/detail/<?php echo $article['slug'];?>&title=<?php echo $article['title']; ?>" width="71" height="20" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"> <i class="fa fa-facebook"></i> <span class="hidden-xs">Share on Facebook</span></a></li>
                                            
                                            <li> <a href="https://www.facebook.com/sharer.php?u=http://127.0.0.1/berita/article/detail/<?php echo $article['slug'];?> &title=<?php echo $article['title']; ?>"  > share </a>  </li>
                                ...
                                <div class="post-media">
                                    <a href="single.html">
                                        <img alt="" src="<?php echo base_url().$article['image'] ?>  " class="img-responsive">
                                    </a>
                                </div>
