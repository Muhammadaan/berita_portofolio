            ...
            <div class="box-header">
             ...
             <form role="form" method="POST" id="form" class="form">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label >Email</label>
                  <p class="help-block error_dup" style="color:#3c8dbc; display:none"></p>
                 <input type="email" class="form-control" id="email" name="email" >
                </div>

                <div class="form-group">
                  <label >Username</label>
                  <p class="help-block error_name" style="color:#3c8dbc; display:none"></p>
                 <input type="input" class="form-control" id="username" name="username" >
                </div>
                <div class="form-group">
                  <label >Password</label>
                  <p class="help-block min_pass" style="color:#3c8dbc; display:none"></p>
                  <input type="password" class="form-control pass" id="pwd" name="pwd" data-rule-minlength="6">
                </div>
                 <div class="form-group">
                  <label >Confirm Password</label>
                   <p class="help-block error_pass" style="color:#3c8dbc; display:none"></p>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $(document).on('blur, change', '#username', function(){
            $.ajax({
                url     : "<?php echo base_url();?>backend/admins/check_username",
                type    : 'POST',
