...
<head>
  ...
  <link rel="stylesheet" href=" <?php echo base_url();?>assets/backend/css/skins/skin-blue.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href=" <?php echo base_url();?>backend/dhasboard" class="logo">
      ...
      <span class="logo-mini"><b>Berita</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Berita</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url()?>backend/profile  " class="btn btn-default btn-flat">Profile</a>
                </div>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li ><a href=" <?php echo base_url();?>backend/dhasboard"><i class="fa fa-dashboard"></i>Dhasboard</a></li>
        <li class="treeview">
          <a href="#">
